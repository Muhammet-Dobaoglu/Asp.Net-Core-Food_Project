...
namespace CoreAndFood.Controllers
{
    public class ChartController : Controller
    {
        ...
        public IActionResult Statistics()
        {
            ...
            var deger4 = c.Foods.Where(x => x.CategoryID == veid).Count();
            ViewBag.d4 = deger4;

            var leid = c.Categories.Where(x => x.CategoryName == "Legumes").Select(y => y.CategoryID).FirstOrDefault();
            var deger6 = c.Foods.Where(x => x.CategoryID == leid).Count();
            ViewBag.d6 = deger6;
            ...
            var deger10 = c.Categories.Where(x => x.CategoryName == "Fruits").Select(y => y.CategoryID).FirstOrDefault();
